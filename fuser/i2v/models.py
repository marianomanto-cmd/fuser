...
# --- Wan 2.2 14B I2V (vídeo) — GGUF Q4_K_M por defecto ------------------------
WAN_I2V_MODELS: List[I2VModelFile] = [
    I2VModelFile(
        key="wan_high_q4",
        filename="Wan2.2-I2V-A14B-HighNoise-Q4_K_M.gguf",
        repo="QuantStack/Wan2.2-I2V-A14B-GGUF",
        path_in_repo="HighNoise/Wan2.2-I2V-A14B-HighNoise-Q4_K_M.gguf",
        subfolder="unet",
        size_gb=9.6,
        kind="video",
        note="Experto de ALTO ruido (primeros pasos de denoising).",
    ),
    I2VModelFile(
        key="wan_low_q4",
        filename="Wan2.2-I2V-A14B-LowNoise-Q4_K_M.gguf",
        repo="QuantStack/Wan2.2-I2V-A14B-GGUF",
        path_in_repo="LowNoise/Wan2.2-I2V-A14B-LowNoise-Q4_K_M.gguf",
        subfolder="unet",
        size_gb=9.6,
        kind="video",
        note="Experto de BAJO ruido (pasos finales de denoising).",
    ),
    I2VModelFile(
        key="umt5_fp8",
    ...
    I2VModelFile(
        ...
        size_gb=0.25,
        kind="video",
        note="VAE de Wan (el 14B I2V usa el VAE de 2.1).",
    ),
]
